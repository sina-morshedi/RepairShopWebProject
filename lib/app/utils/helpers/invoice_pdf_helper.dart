    ...
    pdf.addPage(
      pw.MultiPage(
        ...
        build: (context) => [
          ...
          pw.Row(
            mainAxisSize: pw.MainAxisSize.min, // اندازه فقط به اندازه محتوا
            children: [
              pw.Text("Plaka: $licensePlate", style: pw.TextStyle(font: customFont)),
              pw.SizedBox(width: 20), // فاصله به اندازه 20 واحد (مثل تب)
          ...
          if (log.paymentRecords != null && log.paymentRecords!.isNotEmpty) ...[
            pw.Text("Ödeme Kayıtları:",
                style:
                pw.TextStyle(fontSize: 18, fontWeight: pw.FontWeight.bold, font: customFont)),
            ...
            pw.Align(
              ...
              child: pw.Text(
                ...
                style:
                pw.TextStyle(fontSize: 14, fontWeight: pw.FontWeight.bold, font: customFont),
              ),
            ),
            ...
            pw.Align(
              ...
              child: pw.Text(
                ...
                style: pw.TextStyle(
                    fontSize: 14, fontWeight: pw.FontWeight.bold, color: PdfColors.red, font: customFont),
              ),
            ),
          ],
